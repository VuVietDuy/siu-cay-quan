                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="">
                            <form class="d-flex flex-grow-1">
                                ...
                                <a href="/admin/orders?tab=waiting-for-payment" class="btn btn-light ms-2 d-flex">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary w-100" href="/admin/orders/detail?id=<?php echo $order->id?>">Xem chi
                            tiết</a>
                    </div>
                </div>
            </div>
